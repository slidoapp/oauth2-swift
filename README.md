...
OAuth2 frameworks for **macOS**, **iOS** and **tvOS** written in Swift 6.2.
...
OAuth2 requires Xcode 26, the built framework can be used on **OS X 10.15**, **iOS 13**, **tvOS 13**, **watchOS 6** and later.
