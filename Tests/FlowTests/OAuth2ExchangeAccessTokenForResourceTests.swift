...
class OAuth2ExchangeAccessTokenForResourceTests: XCTestCase {
    ...
    func testExchangeAccessTokenForEventResourceRequest() {
        ...
        let resourceId = "558fca91-002d-4fca-a274-6031dd3119d9"
        let resourceType = Oauth2ResourceType.event
        let req = try! oauth.tokenRequestForExchangeAccessTokenForResource(resourceId: resourceId, resourceType: resourceType).asURLRequest(for: oauth)
    ...
    func testExchangeAccessTokenForOrganizationResourceRequest() {
        let oauth = OAuth2(settings: baseSettings)
        ...
        let resourceId = "558fca91-002d-4fca-a274-6031dd3119d9"
        let resourceType = Oauth2ResourceType.organization
        let req = try! oauth.tokenRequestForExchangeAccessTokenForResource(resourceId: resourceId, resourceType: resourceType).asURLRequest(for: oauth)
    ...
    func testExchangeAccessTokenForTeamspaceResourceRequest() {
        ...
        let resourceId = "558fca91-002d-4fca-a274-6031dd3119d9"
        let resourceType = Oauth2ResourceType.teamspace
        let req = try! oauth.tokenRequestForExchangeAccessTokenForResource(resourceId: resourceId, resourceType: resourceType).asURLRequest(for: oauth)
    ...
    func testExchangeAccessTokenForResource() {
        ...
        try! oauth.doExchangeAccessTokenForResource(resourceId: resourceId, resourceType: resourceType) { token, error in
            XCTAssertNil(error)
