...
open class OAuth2: OAuth2Base {
	...
	*/
    ...
    open func tokenRequestForExchangeAccessTokenForResource(resourceId: String, resourceType: String, params: OAuth2StringDict? = nil) throws -> OAuth2AuthRequest {
        ...
        req.params["resource"] = resourceUrl.absoluteString + "/" + resourceType + "/" + resourceId
    ...
    open func doExchangeAccessTokenForResource(resourceId: String, resourceType: String, params: OAuth2StringDict? = nil, callback: @escaping ((String?, OAuth2Error?) -> Void)) throws {
        do {
